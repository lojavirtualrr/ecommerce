            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/admin/logout" class="btn btn-default btn-flat"><i class="fa fa-share"></i> Sair</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Opções</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-search"></i> Ver loja</a></li>
            <li><a href="/admin/logout"><i class="fa fa-share"></i> Sair</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
