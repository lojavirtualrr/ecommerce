...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Fazer login com
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Fazer login com
        Google+</a>
    </div>
    <!-- /.social-auth-links -->

    <a href="/admin/forgot">Esqueceu a senha ? clique aqui.</a><br>
